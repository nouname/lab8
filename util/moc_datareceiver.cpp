...
QT_MOC_LITERAL(1, 13, 10), // "urlChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 3) // "url"

    },
    "DataReceiver\0urlChanged\0\0url"
};
...
void DataReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataReceiver::urlChanged)) {
                *result = 0;
                return;
            }
        }
